...
def test_replay_pnl_determinism(tmp_path: Path):
    ...
    assert first.pnl_summary == second.pnl_summary
    assert first.pnl_summary is not None
    assert first.pnl_summary["fees_paid_e6"] > 0
